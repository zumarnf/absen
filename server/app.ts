...
/**
 * Build the fully-configured Express application (middleware + routes + error
 * handling) without binding a port or connecting to the database. Keeping app
 * construction separate from the server bootstrap lets integration tests mount
 * the real app with supertest against an in-memory database.
 */
